            ...
            <div class="col-sm-12">
                <div class="col-12">
                    <div class="card recent-sales overflow-auto">
                      ...
                      <div class="card-body">
                        <h5 class="card-title">Data Barang Masuk <a href="{{route('barangmasuk.create')}}" class="btn btn-sm btn-outline-primary float-right">Tambah Data</a></h5>
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td><form action="{{route('barangmasuk.destroy',$data->id)}}" method="post">
                                @method('delete')
                                @csrf
                                <a href="{{route('barangmasuk.edit',$data->id)}}" class="btn btn-warning"><i class="bi bi-pencil-square"></i></a>
